...
class JsonInputDialog(
    ...
    private lateinit var refreshBeanFactoryButton: JCheckBox
    ...
    override fun createMessagePanel(): JPanel {
        ...
        refreshBeanFactoryButton = JCheckBox("RefreshBeanFactory", true)
        refreshBeanFactoryButton.horizontalAlignment = SwingConstants.CENTER
        refreshBeanFactoryButton.addActionListener(object : AbstractAction() {
...
//                SettingsDialog(false).show()
        ...
        settingContainer.add(refreshBeanFactoryButton)
