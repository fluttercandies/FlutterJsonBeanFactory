        ...
        fun generateAllFile(project: Project) {
            ...
            if (pubSpecConfig != null && YamlHelper.shouldActivateFor(project)) {
                try {
                    ...
                    // 使用 WriteCommandAction 包裹所有写操作
                    WriteCommandAction.runWriteCommandAction(project) {
                        // A. 首先生成 JSONField 内容
                        FileGenerator(project).generate()

                        // B. 处理生成的目录
                        val it = FileHelpers.getGeneratedFile(project, pubSpecConfig.generatedPath)
                        ...
                        content.append("\t}")
                        val generated =
                            FileHelpers.getJsonConvertBaseFile(project, pubSpecConfig.generatedPath)
